...
function comp4() {
  return (
    <div style={{marginLeft:"50px"}}>
      <Buttons/>
        <div className="ops" style={{padding:"5px",display:"flex",gap:"10px",marginLeft:300,marginTop:"-40px"}}>
            <button >ALL</button>
            <button >Enabled</button>
            <button >Triggered</button>
            <input type="text" placeholder="search by Models" />
        </div>
        <div style={{width:"100%",height:"200px",border:"2px solid lightgrey",textAlign:"center",marginTop:"10px"}}>graph to be added</div>
